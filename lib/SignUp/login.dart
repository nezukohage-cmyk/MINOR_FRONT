...
//                     ,
//                   ),
//                   Text("Log in for lexi", textAlign: TextAlign.center,
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (_) => const logEmail()));
                  },
                  child: const Align(
                    alignment: Alignment.center,
                    child: Text("continue with email", style: TextStyle(fontSize: 20)),
